...
class OS2{
    ...
    //miscellaneous
    public static String inputPath = "C://Users//tanuj//OneDrive//Desktop//VIT SEM 3//Operating System//OS_Phase1//phase 2//input.txt";
    public static String outputPath = "C://Users//tanuj//OneDrive//Desktop//VIT SEM 3//Operating System//OS_Phase1//phase 2//output.txt";;
    int mem_ptr;
    ...
    public void executeUserProgram(){
        //loading IR
        int ra = realAddress(IC);   //RETURN MEMORY ADDRESS INSIDE PTR
    ...
    public void load(){
        try {
            do {
                int buffer_ptr = 0;
                char [] temp;           //read the line from the file like amj,dta,end
                temp = reader.readLine().toCharArray();
                ...
                if (buffer[0] == '$' && buffer[1] == 'A' && buffer[2] == 'M' && buffer[3] == 'J') {
                    ...
                    //storing job id and ttl and tll in pcb
                    //ascii of 0 is 48
                    ...
                    temp1=Allocate() ;//return an empty memory loc
...
//find and empty frame and assign page table and store frame number temp2 in memory
    ...
    private int realAddress(int VA){
        ...
        int pte = getPTE(VA);   //GET AN RANDOM PAGE TABLE ENTRY ptr+VA/10 EX 22
        if(memory[pte][0] == 'ඞ') {
            PI = 3;
